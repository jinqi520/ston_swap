...
const _PoolV1 = class _PoolV12 extends JettonMinter.JettonMinter {
  ...
  async createCollectFeesBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.COLLECT_FEES, 32).storeUint((params == null ? void 0 : params.queryId) ?? 0, 64).endCell();
  }
  /**
  ...
  async createBurnBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.BURN, 32).storeUint((params == null ? void 0 : params.queryId) ?? 0, 64).storeCoins(BigInt(params.amount)).storeAddress(toAddress.toAddress(params.responseAddress)).endCell();
  }
  /**
