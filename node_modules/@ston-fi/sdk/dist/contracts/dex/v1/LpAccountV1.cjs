...
const _LpAccountV1 = class _LpAccountV12 extends Contract.Contract {
  ...
  async createRefundBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.REFUND_ME, 32).storeUint((params == null ? void 0 : params.queryId) ?? 0, 64).endCell();
  }
  /**
  ...
  async createDirectAddLiquidityBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.DIRECT_ADD_LIQUIDITY, 32).storeUint((params == null ? void 0 : params.queryId) ?? 0, 64).storeCoins(BigInt(params.amount0)).storeCoins(BigInt(params.amount1)).storeCoins(BigInt(params.minimumLpToMint ?? 1)).endCell();
  }
  /**
  ...
  async createResetGasBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.RESET_GAS, 32).storeUint((params == null ? void 0 : params.queryId) ?? 0, 64).endCell();
  }
  /**
