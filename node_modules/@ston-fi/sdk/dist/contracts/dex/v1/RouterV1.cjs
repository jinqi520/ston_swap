...
const _RouterV1 = class _RouterV12 extends Contract.Contract {
  ...
  async createSwapBody(params) {
    ...
    builder.storeUint(constants$1.DEX_OP_CODES.SWAP, 32);
  ...
  async createProvideLiquidityBody(params) {
    return ton.beginCell().storeUint(constants$1.DEX_OP_CODES.PROVIDE_LP, 32).storeAddress(toAddress.toAddress(params.routerWalletAddress)).storeCoins(BigInt(params.minLpOut)).endCell();
  }
  /**
