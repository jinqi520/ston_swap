...
const _PtonV1 = class _PtonV12 extends JettonMinter.JettonMinter {
  ...
  async createDeployWalletBody(params) {
    return ton.beginCell().storeUint(constants$1.pTON_OP_CODES.DEPLOY_WALLET, 32).storeUint(params.queryId ?? 0, 64).storeAddress(toAddress.toAddress(params.ownerAddress)).endCell();
  }
